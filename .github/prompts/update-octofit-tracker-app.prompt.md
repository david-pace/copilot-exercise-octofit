...
3. Ensure `/` points to the api and `api_root` is present in `urls.py`. (Siehe <attachments> oben für Dateiinhalte. Sie müssen die Datei möglicherweise nicht erneut suchen oder lesen.)
